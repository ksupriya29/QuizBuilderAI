...
export default function UploadScreen({ onContinue }) {
  ...
  const handleFile = async (f) => {
    ...
    try {
      ...
      setError("Failed to parse. Make sure backend is running.")
    }
    setLoading(false)
  }
    ...
    <div className="screen">
      <div className="card">
        ...
        >
          ...
          <p style={{ fontWeight: 700, fontSize: 18 }}>Drag & drop your .pptx here</p>
          <p style={{ color: "#94a3b8", fontSize: 13, marginTop: 6 }}>
            or click to browse · .pptx only · max 25MB
          </p>
          <input
            ref={inputRef}
            type="file"
          ...
          <div className="success-badge">
            ...
            <div>
              ...
              <p style={{ color: "#94a3b8", fontSize: 13 }}>
                {parsed.slide_count} slides · {parsed.word_count} words extracted
              </p>
            </div>
